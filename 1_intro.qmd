...
productHead <- head(productSheet, n = 5L)
## very strange error where kable thinks there is an extra first column
kable(productHead[,2:7])
```
...
source(paste0(here(), "/data/ingredientRegex.R"))
